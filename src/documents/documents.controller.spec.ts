...
describe('DocumentsController', () => {
  ...
  describe('create', () => {
    ...
    it('should throw BadRequestException for invalid metadata', async () => {
      ...
      await expect(controller.create(metadataStr, file, req)).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should throw BadRequestException for file size exceeding limit', async () => {
      ...
      mockDocumentsService.create.mockImplementation(() => {
        throw new BadRequestException(
          'Service should not be called for oversized files',
        );
      });
  ...
  describe('update', () => {
    it('should update a document when user has admin role', async () => {
      ...
      expect(await controller.update(req, id, updateDocumentDto)).toBe(
        expectedResult,
      );
